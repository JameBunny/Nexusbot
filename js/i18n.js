  ...
  var translations = {
    th: {
      ...
      commands: {
        ...
        shuffleDesc: "สุ่มเรียงลำดับเพลงในคิว",
        lyricsDesc: "แสดงเนื้อเพลงของเพลงที่กำลังเล่น",
        clearqueueDesc: "ล้างเพลงทั้งหมดในคิว",
        removeDesc: "ลบเพลงที่ระบุออกจากคิว (ระบุลำดับเลข)",
        jumpDesc: "กระโดดไปเล่นเพลงลำดับที่ระบุทันที",
        moveDesc: "ย้ายตำแหน่งเพลงในคิว (จาก -> ไป)",
        // Advanced/Settings
        bassboostDesc: "🎧 ปรับระดับเสียงเบส (Bass Effects)",
      ...
      shop: {
        ...
        lifetimeFeature3: "เข้าถึงฟีเจอร์ใหม่ก่อนใคร (Early Access)",
        lifetimeFeature4: "เปลี่ยนรูปโปรไฟล์บอทได้ (Custom Avatar)",
        lifetimeFeature5: "ยศ VIP ใน Discord Support",
    ...
    en: {
      ...
      commands: {
        ...
        volumeDesc: "Adjust volume (1-100)",
        ...
        // Advanced/Settings
        bassboostDesc: "🎧 Adjust bass level (Bass Effects)",
    ...
    ja: {
      ...
      commands: {
        ...
        // Advanced
        bassboostDesc: "🎧 ベースレベルを調整 (Bass Effects)",
        bassOff: "通常、クリアなサウンド",
        bassLow: "ソフト＆ディープ (ドライブ向け)",
        bassMedium: "パンチの効いた低音 (クラブ/バー)",
        bassHigh: "激しい振動 (コンサート)",
        bassExtreme: "歪んだ低音/鼓膜崩壊 (警告!)",
